...
public enum MarketLang {
    ...
    EMBARGO_GLOBAL(NationsLang.NATION),
    EMBARGO_GLOBAL_FORMAT(""),
    NO_EMBARGOES_FOUND(NationsLang.NATION),
    EMBARGO_LOCAL_INCOMING(NationsLang.NATION),
    EMBARGO_LOCAL_OUTGOING(NationsLang.NATION),
    EMBARGO_LOCAL_FORMAT(""),
    ...
    BALANCE_CLEARED_SENDER(Lang.PIXLIES),
    BALANCE_CLEARED_TARGET(Lang.PIXLIES),
